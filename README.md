...
For documentation and manuals visit our [github.io page](https://biopet.github.io/findcompound).

# About


FindCompound is part of BIOPET tool suite that is developed at LUMC by [the SASC team](http://sasc.lumc.nl/).
...
For any question related to FindCompound, please use the
<a href='https://github.com/biopet/findcompound/issues'>github issue tracker</a>
or contact
